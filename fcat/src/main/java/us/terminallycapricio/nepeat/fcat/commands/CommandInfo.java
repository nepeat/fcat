...
public class CommandInfo extends CommandBase {
	...
	public void onCommand(CommandSender sender, Command cmd, String label,
		...
		sender.sendMessage("[fcat] Explosion chance: "
				+ fcatMain.plugin.getConfig().get("explodechance"));
		sender.sendMessage("[fcat] Egg type: "
				+ fcatMain.plugin.getConfig().get("eggtype"));
	}
